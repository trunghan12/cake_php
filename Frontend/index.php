    ...
    <div class="container">
        <div class="row">
            <div class="d-flex justify-content-between mt-5">
                <a href="index.php" style="margin-top: 8px">Home</a>
                <div class="nav-item dropdown">
                    <a href="about.php" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Sản phẩm của chúng tôi</a>
                    <div class="dropdown-menu m-0">
                        <a href="about.php" class="dropdown-item">Bánh kem ngon</a>
                        <a href="about.php" class="dropdown-item">Bánh sự kiện</a>
                        <a href="about.php" class="dropdown-item">Bánh độc lạ</a>
                        <a href="about.php" class="dropdown-item">Người thân yêu</a>
                        <a href="about.php" class="dropdown-item">Nhân vật hoạt hình</a>
                        <a href="about.php" class="dropdown-item">Bánh đẹp</a>
                        <a href="about.php" class="dropdown-item">Bánh in hình ảnh</a>
                        <a href="about.php" class="dropdown-item">Gato nhiều tầng</a>
                        <a href="about.php" class="dropdown-item">Trái tim</a>
                        <a href="about.php" class="dropdown-item">Bánh 12 con giáp</a>
                        <a href="about.php" class="dropdown-item">Dịp tặng</a>
                        <a href="about.php" class="dropdown-item">Bánh sinh nhật</a>
                        <a href="about.php" class="dropdown-item">Tặng khách hàng</a>
                        <a href="about.php" class="dropdown-item">Combo Hoa tươi-Bánh</a>
                    </div>
                
                </div>
                <div>
                    <div class="btn-group mt-4">
                        <a href="http://127.0.0.1:5500/ex4/website-dulich/about.html" class="btn btn-primary">Trang chủ</a>
                        <a href="http://127.0.0.1:5500/ex4/website-dulich/service.html" class="btn btn-primary">Dịch vụ</a>
                        <a href="http://127.0.0.1:5500/ex4/website-dulich/index.html" class="btn btn-primary">Về chúng tôi</a>
                        <a href="http://127.0.0.1:5500/ex4/website-dulich/faq.html" class="btn btn-primary">FAQ</a>
                        <a href="http://127.0.0.1:5500/ex4/website-dulich/contact.html" class="btn btn-primary">Liên hệ</a> 
                      </div>
                </div>
            </div>
            <hr>
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto mx-lg-auto py-0">
                ...
                <a href="menu.php" class="nav-item nav-link">Blog</a>
                <a href="team.php" class="nav-item nav-link">Giới thiệu</a>
